import perlinSrc from '../assets/perlin-512.png';
import particleSrc from '../assets/particle2.png';
...
THREE.GPUParticleSystem = function ( options ) {
	...
	this.particleNoiseTex = this.PARTICLE_NOISE_TEXTURE || textureLoader.load( perlinSrc );
	this.particleNoiseTex.wrapS = this.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	this.particleSpriteTex = this.PARTICLE_SPRITE_TEXTURE || textureLoader.load( particleSrc );
