...
import atlasSrc from "../../phaser_assets/atlas.png";
import atlasJson from "../../phaser_assets/atlas.json";
...
assetManager.loadAssets = function (main, callback) {
    ...
    var imagesToLoad = [
        ...
        {type: 'image', src:require('../../phaser_assets/box.png'), key:"box"},
        {type: 'image', src:require('../../phaser_assets/block.png'), key:"block"},
        {type: 'image', src: require('../../phaser_assets/gold.png'), key:"gold"},
        ...
        {
            type: "spritesheet",
            src: require('../../phaser_assets/particles.png'),
            frameWidth: 384/3,
            frameHeight: 384/3,
            key: "particles"
        }
...
function prepareSounds() {
    ...
    if (app.data.music1Src && app.data.music2Src) {
        var music1 = new Howl({
            src: [app.data.music1Src],
            loop: true,
            volume: 0.5
        });

        var music2 = new Howl({
            src: [app.data.music2Src],
            loop: true,
            volume: 0.5
        });

        app.playMusic = function () {
            if (!app.main.soundEnabled || music1.playing() || music2.playing()) return;
            music1.play();
            music2.play();
        }
